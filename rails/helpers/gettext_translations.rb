module ConvergeUi::GettextTranslations
  TRANSLATIONS = {
    ...
    :login_unknown            => _('Username Unknown'),
    :login_unknown_info       => _("If you do not know your username, please enter your email address below and your username information will be sent to you."),
