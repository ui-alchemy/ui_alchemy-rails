...
(function($) {
    ...
    $.editable = function(selector, options) {
        var settings        = $.extend({}, $.editable.defaults, options),
            ...
            oneditcomplete  = settings.oneditcomplete   || function() { },
            onresetcomplete = settings.onresetcomplete  || function() { };

        $(selector).live(settings.event, function(e) {
            var $element = $(this);

            /* show tooltip */
            if (settings.tooltip) {
                $element.attr('title', settings.tooltip);
            }
            
            settings.target = settings.target || $element.data('url');
            settings.name   = $element.data('name');
            settings.data   = settings.data || undefined;
            ...
            if (settings.loadurl) {
                ...
                if ($.isFunction(settings.data)) {
                    ...
                    input_content = $element.data(settings.data);
                }
            } else {
    ...
    /* Add new input type */
    $.editable.addInputType = function(name, input) {
